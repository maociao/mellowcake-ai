...
def load_model(
    ...
    # Force float32 to prevent NaNs on AMD ROCm for long sequences
    dtype = torch.float32
...
def infer_batch_process(
    ...
    def process_batch(gen_text):
        ...
        # Clone audio to prevent in-place modification issues across batches
        ...
        # inference
        # unexpected NaNs on ROCm with Flash Attention, forcing math kernel
        ...
        if generated_waves:
            if cross_fade_duration <= 0:
                ...
                for i in range(1, len(generated_waves)):
                    ...
                    # Cross-faded overlap
                    cross_faded_overlap = (prev_overlap * fade_out + next_overlap * fade_in).astype(np.float32)
